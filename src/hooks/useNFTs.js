                            ...
                            try {
                                ...
                                if (uri) {
                                    ...
                                    if (json.properties && json.properties.creators) {
                                        ...
                                        const collectionCreators = COLLECTION.METADATA.creators;
                                        if (collectionCreators && collectionCreators.length > 0) {
                                            const creatorMatch = collectionCreators.some(collectionCreator => creators.some(nftCreator => nftCreator.address === collectionCreator.address));
                                            if (creatorMatch) {
                                                isPartOfCollection = true;
                                            }
                                        }
